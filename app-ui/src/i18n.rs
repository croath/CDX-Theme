...
pub fn translate(locale: Locale, key: &str) -> &'static str {
  match (locale, key) {
    ...
    // App update notification (left nav)
    (Locale::EnUs, "update.available") => "Update available",
    (Locale::ZhHans, "update.available") => "有新版本可用",
    (Locale::ZhHant, "update.available") => "有新版本可用",
    (Locale::JaJp, "update.available") => "アップデートがあります",
    (Locale::KoKr, "update.available") => "업데이트 가능",
    (Locale::DeDe, "update.available") => "Update verfügbar",
    (Locale::EsEs, "update.available") => "Actualización disponible",

    (Locale::EnUs, "update.hint") => "New version ready to download",
    (Locale::ZhHans, "update.hint") => "可下载新版本",
    (Locale::ZhHant, "update.hint") => "可下載新版本",
    (Locale::JaJp, "update.hint") => "新しいバージョンをダウンロードできます",
    (Locale::KoKr, "update.hint") => "새 버전을 다운로드할 수 있습니다",
    (Locale::DeDe, "update.hint") => "Neue Version zum Download bereit",
    (Locale::EsEs, "update.hint") => "Nueva versión lista para descargar",

    (Locale::EnUs, "update.hint.ready") => "Restart to apply the update",
    (Locale::ZhHans, "update.hint.ready") => "安装后将重启应用",
    (Locale::ZhHant, "update.hint.ready") => "安裝後將重啟應用",
    (Locale::JaJp, "update.hint.ready") => "インストール後に再起動します",
    (Locale::KoKr, "update.hint.ready") => "설치 후 앱이 다시 시작됩니다",
    (Locale::DeDe, "update.hint.ready") => "Nach Installation wird neu gestartet",
    (Locale::EsEs, "update.hint.ready") => "Se reiniciará al instalar",

    (Locale::EnUs, "update.download") => "Download",
    (Locale::ZhHans, "update.download") => "下载",
    (Locale::ZhHant, "update.download") => "下載",
    (Locale::JaJp, "update.download") => "ダウンロード",
    (Locale::KoKr, "update.download") => "다운로드",
    (Locale::DeDe, "update.download") => "Herunterladen",
    (Locale::EsEs, "update.download") => "Descargar",

    (Locale::EnUs, "update.downloading") => "Downloading…",
    (Locale::ZhHans, "update.downloading") => "下载中…",
    (Locale::ZhHant, "update.downloading") => "下載中…",
    (Locale::JaJp, "update.downloading") => "ダウンロード中…",
    (Locale::KoKr, "update.downloading") => "다운로드 중…",
    (Locale::DeDe, "update.downloading") => "Wird heruntergeladen…",
    (Locale::EsEs, "update.downloading") => "Descargando…",

    (Locale::EnUs, "update.ready") => "Ready to install",
    (Locale::ZhHans, "update.ready") => "已下载，可安装",
    (Locale::ZhHant, "update.ready") => "已下載，可安裝",
    (Locale::JaJp, "update.ready") => "インストールの準備完了",
    (Locale::KoKr, "update.ready") => "설치 준비 완료",
    (Locale::DeDe, "update.ready") => "Bereit zur Installation",
    (Locale::EsEs, "update.ready") => "Listo para instalar",

    (Locale::EnUs, "update.install") => "Install",
    (Locale::ZhHans, "update.install") => "安装",
    (Locale::ZhHant, "update.install") => "安裝",
    (Locale::JaJp, "update.install") => "インストール",
    (Locale::KoKr, "update.install") => "설치",
    (Locale::DeDe, "update.install") => "Installieren",
    (Locale::EsEs, "update.install") => "Instalar",

    (Locale::EnUs, "update.installing") => "Installing…",
    (Locale::ZhHans, "update.installing") => "安装中…",
    (Locale::ZhHant, "update.installing") => "安裝中…",
    (Locale::JaJp, "update.installing") => "インストール中…",
    (Locale::KoKr, "update.installing") => "설치 중…",
    (Locale::DeDe, "update.installing") => "Wird installiert…",
    (Locale::EsEs, "update.installing") => "Instalando…",

    (Locale::EnUs, "update.error") => "Update failed",
    (Locale::ZhHans, "update.error") => "更新失败",
    (Locale::ZhHant, "update.error") => "更新失敗",
    (Locale::JaJp, "update.error") => "更新に失敗しました",
    (Locale::KoKr, "update.error") => "업데이트 실패",
    (Locale::DeDe, "update.error") => "Update fehlgeschlagen",
    (Locale::EsEs, "update.error") => "Error al actualizar",

    (Locale::EnUs, "update.dismiss") => "Dismiss",
    (Locale::ZhHans, "update.dismiss") => "关闭",
    (Locale::ZhHant, "update.dismiss") => "關閉",
    (Locale::JaJp, "update.dismiss") => "閉じる",
    (Locale::KoKr, "update.dismiss") => "닫기",
    (Locale::DeDe, "update.dismiss") => "Schließen",
    (Locale::EsEs, "update.dismiss") => "Cerrar",
